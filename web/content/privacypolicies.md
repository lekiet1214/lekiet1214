...
- **Application** means the software program provided by the Company downloaded by You on any electronic device, named Auto Instagram Dark Mode
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Auto Instagram Dark Mode.
...
We will let You know via email and/or a prominent notice on Our Service, before the change becbecomesfective and update the "Last updated" date at the top of this Privacy Policy.
